                            ...
                            if (userID) {
                                ...
                                file.create('users', email, userObject, function (err) {
                                    if (!err) {
                                        ...
                                        fs.mkdir(handler.fileDir + 'products' + '/' + userID, {
                                            recursive: false
                                        }, function (err) {
                                            if (!err) {
                                                // Create Purchase file
                                                fs.mkdir(handler.fileDir + 'purchases' + '/' + userID, {
                                                    recursive: false
                                                }, function (err) {
                                                    if (!err) {
                                                        // Create Customer's file
                                                        fs.mkdir(handler.fileDir + 'customers' + '/' + userID, {
                                                            recursive: false
                                                        }, function (err) {
                                                            if (!err) {
                                                                // Create sale's file
                                                                fs.mkdir(handler.fileDir + 'sales' + '/' + userID, {
                                                                    recursive: false
                                                                }, function (err) {
                                                                    if (!err) {
                                                                        // Create chart's file
                                                                        fs.mkdir(handler.fileDir + 'charts' + '/' + userID, {
                                                                            recursive: false
                                                                        }, function (err) {
                                                                            if (!err) {
                                                                                // Create chart's file
                                                                                fs.mkdir(handler.fileDir + 'productById' + '/' + userID, {
                                                                                    recursive: false
                                                                                }, function (err) {
                                                                                    if (!err) {
                                                                                        // Create chart's file
                                                                                        fs.mkdir(handler.fileDir + 'totalSales' + '/' + userID, {
                                                                                            recursive: false
                                                                                        }, function (err) {
                                                                                            if (!err) {
                                                                                                // Send welcome email
